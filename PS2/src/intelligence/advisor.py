...
def synthesize_actionable_advice(
    ...
    if not is_delayed:
        return {
            ...
            "one_line_advice": "No action needed. Head out at your usual 07:40 AM.",
    ...
    one_liner = f"Switch to Downtown Line at Tampines Downtown: Arrive {dtl_arrival} (On Time for 09:00 meeting)."
